...
export default function Schedules() {
    return (
        <div className="flex flex-col items-center bg-mainBg min-h-screen h-screen-sm w-[414px] h-[896px]">
            ...
            <h1 className="text-white mt-5 text-xl font-bold mb-10">Horários COHAB2</h1>
            ...
            <div className="flex justify-around w-full">
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    {SchedulesData[0].COHAB2Util.map((horario, index) => (
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    {SchedulesData[0].COHAB2CentroUtil.map((horario, index) => (
