...
export default function Schedules() {
    return (
        <div className="flex flex-col items-center bg-mainBg min-h-screen h-screen-sm w-[414px] h-[1200px]">
            ...
            <div className="flex w-full">
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    {SchedulesData[0].BrasiliaUtil.map((horario, index) => (
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    {SchedulesData[0].BrasiliaCentroUtil.map((horario, index) => (
